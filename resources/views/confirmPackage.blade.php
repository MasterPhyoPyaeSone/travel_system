...
<body>
  ...
  <header class="header">
    <div class="container">
      <nav class="navbar flex1" style="display: flex;justify-content: space-between;align-items: center;">
        <div class="logo" style="margin-top: -10px;backgroud-image: none;margin-left: 100px;display: flex">
          {{-- <img src="/image/logo.png" alt=""> --}}
          <img src="/image/pngegg.png" style="width: 100px;height: 100px;color: #f85959" alt=""><span style="color: #f85959;font-weight: bold;font-size: 20px;margin-top: 35px">LOCAL  14 </span>

        </div>

        <div class="d" style="margin-left: 50px">
        ...
        <div class="sticky" style="display: flex;">
		      ...
		      @if (auth()->check())
           <div class="">
            <p class="nav-link icon" style="color: #fff;margin-right: 30px;margin-top: -7px"><a href="/Profile" class="nav-link" style="border: none;background-color: transparent;font-size: 20px;margin-top: 3px;color: #fff"><i class="fas fa-user fa-lg icon"  class="nav-link" style="color: black"></i></a> </p>
           </div>
		      @endif
 ...
 <section>
    <div class="w-full h-[100vh] flex items-center justify-center ">
        <div class="w-[60%] mx-auto pb-[50px] bg-white border-2 shadow-md rounded-md px-[30px]">
            <p class="text-[25px] font-bold text-center mb-[50px] mt-[40px]">Payment
                Method</p>
<div class="w-full flex">
            <div class="w-[50%] px-[50px]">
                <div class="w-full flex gap-5 ">
                    <div class="flex gap-2 items-center"><input id="kbz-btn" class="w-5 h-5" name="payment"
                            type="radio" onclick="kbz()">
                        <img class="w-8 h-8"
                            src="https://play-lh.googleusercontent.com/cnKJYzzHFAE5ZRepCsGVhv7ZnoDfK8Wu5z6lMefeT-45fTNfUblK_gF3JyW5VZsjFc4"
                            alt>
                    </div>
                    <div class="flex gap-2 items-center"><input id="wave-btn" class="w-5 h-5" name="payment"
                            type="radio" onclick="wave()">
                        <img class="w-8 y-8"
                ...
                <div class="" style="margin-top: 30px">
                    <h2 style="font-size: 25px;font-weight: bold">Total Cost <span style="color: #CC8C18;margin-left: 10px">{{$total}} Ks</span></h2>
                </div>
                <form action="/confirmOrderSuccess" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="total_price" value="{{$total}}">
               <div class="w-full mt-5  flex flex-col gap-3">
                <input class="w-full px-4 py-3 outline-none rounded-md shadow-md" type="text" placeholder="Account Username" value="{{auth()->user()->name}}" required>
                <input class="w-full px-4 py-3 outline-none rounded-md shadow-md" type="tel" placeholder=" Phone Number" required max="11">
                {{-- <input class="w-full px-4 py-3 outline-none rounded-md shadow-md" type="text" placeholder="Billing Number"> --}}


                <div class="w-full ">
                    <label class="block mb-2  font-semibold text-lg" for="large_size">Please upload payment_screenshot</label>
                    <input class="block w-full shadow-md  text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50  placeholder-gray-400" id="large_size" type="file" name="img" required>
                </div>
                <div class="w-full flex justify-center items-center mt-5">
                    <button type="submit" class="bg-blue-900 text-white px-[30px] py-2 rounded-lg">Comfirm</button>
                </div>
               </div>
            </form>
            </div>
            <div class="w-[50%]">
                <img id="payment" class="w-[500px] h-[300px]" src="https://img.freepik.com/free-vector/people-using-online-payment-mobile-app-cartoon-illustration_74855-14481.jpg " alt="">
            </div>
        </div>
        </div>
    </div>
...
<script>
    function kbz(){
        ...
        document.getElementById('kbz-btn').onclick = function(){
            document.getElementById("payment").src = "/image/photo_kpay1.jpg";                    
    ...
    function wave(){
       ...
       document.getElementById('wave-btn').onclick = function(){
           document.getElementById("payment").src = "/image/wave.jpg";                    
