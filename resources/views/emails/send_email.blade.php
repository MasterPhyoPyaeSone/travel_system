...
{{-- This is a test email from Laravel & Mailtrap. The details are: --}}
    ...
    <div class="">
        <div class="container" style="width: 500px;margin-left: 22%;">
            ...
            <div class="clo" style="display: flex;;align-items: center;justify-content: space-evenly;">
                ...
                <div class="col2" style="font-size: 20px;color: greenyellow;font-weight: bold;">
                    <p>Local14 ID: <span style="color: black">{{$data->id}}</span></p>
                    <p>{{$data->hotel_name}}/{{$data->room_type}}</p>
                    <p>{{$data->startDate}}</p>
                </div>
            </div>
            <hr>
