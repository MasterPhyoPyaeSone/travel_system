    ...
    <div class="w-full h-[100vh] flex items-center justify-center ">
        ...
        <div class="w-full flex">
            <div class="w-[50%] px-[50px]">
                ...
                <form action="/confirmOrderRoomSuccess" method="post" enctype="multipart/form-data">
                    @csrf
               ...
               <div class="w-full mt-5  flex flex-col gap-3">
                ...
                <input class="w-full px-4 py-3 outline-none rounded-md shadow-md" type="tel" placeholder=" Phone Number" required>
